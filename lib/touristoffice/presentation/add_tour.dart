...
class _AddTourState extends State<AddTour> {
  ...
  var ourprogramincludecontroller = TextEditingController();
               ...
               Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image:  DecorationImage(
                          ...
                          image: AssetImage("images/malaysia7.jpg",),
                          fit: BoxFit.fitWidth,
                        ),
                      ),
                    ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value){
                                  if(value!.isEmpty){
                                    return "places must not be empty";//S.of(context).pageEmailAddress;
                                  }
                                  return null;
                                },
                                decoration: InputDecoration(
                                  ...
                                  hintText: "places ",//S.of(context).pageEnterEmail,
                                  enabledBorder: InputBorder.none,
                                  focusedBorder: InputBorder.none,
                                ),
                              ),
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                controller: ourprogramincludecontroller,
                                keyboardType: TextInputType.name,
                                cursorColor: Color(0xffF5591F),
                                onFieldSubmitted: (value){
                                  print(value);
